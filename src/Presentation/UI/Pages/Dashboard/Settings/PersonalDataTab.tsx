			...
			<div className="p-8 flex flex-col gap-8">
				...
				<div className="flex flex-col gap-2 text-[#111827]"> 
					...
					<div className="flex items-center gap-2">
						<div className="h-[36px] px-3 border border-[#D1D5DB] rounded-[4px] bg-[#F8F8F8] text-[13px] text-gray-700 flex items-center">
							ID +62
						</div>
						<input
							type="text"
							className="flex-1 h-[36px] border border-[#D1D5DB] rounded-[4px] px-3 text-[13px] font-normal focus:outline-none"
				...
				<div className="flex flex-col gap-2 text-[#111827]"> 
					...
					{livingAbroad ? (
						...
						<select className="h-[36px] border border-[#D1D5DB] rounded-[4px] px-3 text-[13px] font-normal focus:outline-none bg-white">
							<option>Depok</option>
							<option>Jakarta</option>
							<option>Bandung</option>
						</select>
					)}
					<p className="text-[12px] text-gray-500">Fill in the city/region where you currently live.</p>
				</div>
				...
				<div className="flex flex-col gap-2 text-[#111827]"> 
					...
					<p className="text-[12px] text-gray-500">Fill in the city/region where you were born.</p>
				</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div className="flex flex-col gap-2 text-[13px] font-semibold">
						...
						<input
							...
							className="w-full h-[36px] border border-[#D1D5DB] rounded-[4px] px-3 text-[13px] font-normal focus:outline-none"
						/>
					</div>
					...
					<div className="flex flex-col gap-2 text-[13px] font-semibold">
						...
						<div className="flex flex-col gap-2 text-[13px] font-normal text-[#111827]">
							<label className="flex items-center gap-2">
								<input type="radio" name="gender" className="accent-[#285F3E]" defaultChecked /> 
								<span>Male</span>
							</label>
							<label className="flex items-center gap-2">
								<input type="radio" name="gender" className="accent-[#285F3E]" />
								<span>Female</span>
							</label>
							<label className="flex items-center gap-2">
								<input type="radio" name="gender" className="accent-[#285F3E]" />
