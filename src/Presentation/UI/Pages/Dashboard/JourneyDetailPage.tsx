...
const JourneyDetailPage = () => {
	...
	return (
		<>
			<div className="px-4 sm:px-8 lg:px-13 py-4 sm:py-5 lg:py-6 pt-16 lg:pt-6 w-full overflow-y-auto h-screen bg-[#F4F2EC]">
				{/* Back Button */}
				...
				{/* Hero Section */}
				<div className="bg-white rounded-2xl lg:rounded-3xl p-5 sm:p-6 lg:p-8 shadow-sm border border-gray-100 mb-6 sm:mb-8 relative overflow-hidden">
					{/* Background Decoration */}
					<div className="absolute top-0 right-0 w-64 h-64 bg-[#285F3E]/5 rounded-full blur-3xl -mr-16 -mt-16 pointer-events-none"></div>

					<div className="flex flex-col md:flex-row gap-6 sm:gap-8 lg:gap-10 relative z-10">
						{/* Image */}
									...
									<div className="flex flex-col ml-4">
										...
										<div className="w-32 h-2 bg-gray-100 rounded-full overflow-hidden">
											<div
												...
												style={{
													width: `${journey.progress_info.percentage}%`,
												}}></div>
										</div>
									</div>
								)}
				...
				<div className="grid grid-cols-12 gap-4 sm:gap-6 lg:gap-8">
					...
					<div className="col-span-12 lg:col-span-8">
						<div className="bg-white rounded-2xl lg:rounded-3xl p-4 sm:p-5 md:p-6 lg:p-8 shadow-sm border border-gray-100">
					...
					{/* Sidebar Info */}
					<div className="col-span-12 lg:col-span-4 flex flex-col gap-4 sm:gap-5 lg:gap-6">
						{/* What you'll learn */}
						<div className="bg-white rounded-2xl lg:rounded-3xl p-4 sm:p-5 md:p-6 lg:p-8 shadow-sm border border-gray-100">
							<div className="flex items-center gap-3 mb-6">
								<div className="p-2 bg-[#285F3E]/10 rounded-lg text-[#285F3E]">
