		...
		<div className="flex h-screen overflow-hidden">
			...
			<div className="flex-1 px-8 py-6 overflow-y-auto mr-[310px]">
				...
				<div className="relative w-full bg-[#285F3E] rounded-xl overflow-hidden px-6 py-4 mb-5 flex items-center justify-between shadow-sm">
					...
					<Button size="sm" variant="secondary" className="bg-white/10 text-white hover:bg-white/20 border-none h-8 text-xs">
						View Report
					</Button>
				</div>
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-5">
							...
							<div className="flex flex-col gap-2">
								<div className="flex items-center gap-3 p-2 bg-orange-50 rounded-lg border border-orange-100">
									...
									<div className="min-w-0">
										<h4 className="font-medium text-[#202020] text-[12px] truncate">React Hooks</h4>
										<p className="text-[10px] text-gray-500 truncate">Review `useMemo`</p>
									</div>
								</div>
								<div className="flex items-center gap-3 p-2 bg-blue-50 rounded-lg border border-blue-100">
									...
									<div className="min-w-0">
										<h4 className="font-medium text-[#202020] text-[12px] truncate">CSS Grid</h4>
										<p className="text-[10px] text-gray-500 truncate">Complex layouts</p>
									</div>
								</div>
							</div>
						</CardContent>
					...
					<Card className="border-none shadow-sm bg-white">
						...
						<CardContent className="px-4 pb-4">
							<p className="text-gray-500 text-[10px] mb-2">
								Most active: <span className="font-bold text-[#285F3E]">08:00 - 11:00</span>
							</p>
							<div className="h-20 flex items-end justify-between gap-1.5">
								{[40, 70, 30, 85, 50, 20, 60].map((h, i) => (
									<div key={i} className="w-full bg-green-50 rounded-t-sm relative group">
										<div 
					...
					<Card className="border-none shadow-sm bg-white">
						...
						<CardContent className="px-4 pb-4 flex items-center gap-4">
							...
							<div>
								<p className="text-[12px] font-medium text-[#202020]">Frontend Master</p>
				...
				<Card className="border-none shadow-sm bg-white mb-5">
					...
					<CardContent className="px-4 pb-4">
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							<div className="p-3 rounded-lg bg-gradient-to-r from-green-50 to-emerald-50 border border-green-100 flex gap-3 items-center">
								<div className="p-2 bg-white rounded-md shadow-sm text-[#285F3E] shrink-0">
									<i className="ri-lightbulb-flash-line text-lg"></i>
								</div>
								<div className="flex-1 min-w-0">
									<h4 className="font-medium text-[#202020] text-[12px]">Quiz: React Performance</h4>
									<p className="text-[10px] text-gray-600 truncate">Test your knowledge of re-renders.</p>
								</div>
								<Button size="sm" className="h-7 text-xs bg-[#285F3E] hover:bg-[#1e462e] px-3">Start</Button>
							</div>
							...
							<div className="p-3 rounded-lg bg-white border border-gray-100 flex gap-3 items-center hover:shadow-md transition-shadow cursor-pointer">
								...
								<div className="flex-1 min-w-0">
									<h4 className="font-medium text-[#202020] text-[12px]">Read: "Future of UI"</h4>
									<p className="text-[10px] text-gray-600 truncate">Curated for your Design Systems interest.</p>
								</div>
